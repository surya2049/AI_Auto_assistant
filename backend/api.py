...
class AssistantFnc(llm.FunctionContext):
    ...
    def lookup_car(self, vin: Annotated[str, llm.TypeInfo(description="The registration of the car to lookup")]):
    ...
    def create_car(
        self, 
        vin: Annotated[str, llm.TypeInfo(description="The registration of the car")],
